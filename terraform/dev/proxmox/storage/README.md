...
| Module | Description |
|--------|-------------|
| `nas` | NFS mounts: shared ISOs, `nas-dev-data`, `nas-backups` |
...
| `nas-dev-data` | `images`, `rootdir`, `backup` | VM disks, LXC rootfs, env backups |
...
|---------|-------------|-----|
| `nas-dev-data` backup content | 2 | Quick rollback for recent changes |
...
- [`../../../../.github/workflows/dev-proxmox-storage.yml`](../../../../.github/workflows/dev-proxmox-storage.yml) — apply workflow
