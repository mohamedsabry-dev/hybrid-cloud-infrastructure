...
|----------|------------|-------------|
| `aws_security_group` | `wireguard-sg-prod` | SG for the WireGuard EC2 |
| `aws_key_pair` | `vpn-key-pair-prod` | SSH key pair for EC2 access |
| `aws_instance` | `wireguard-prod` (Name tag) | WireGuard VPN server (t3.micro, AL2023) |
| `aws_eip` | `wireguard-eip-prod` (Name tag) | Elastic IP for stable public endpoint |
