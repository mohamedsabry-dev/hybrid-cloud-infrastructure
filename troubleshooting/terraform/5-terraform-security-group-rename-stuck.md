...
- Security group deletion takes 2+ minutes without progress
...
**Terraform behavior:** When a security group name changes (immutable attribute), Terraform plans "destroy and then create replacement" (`-/+`):
...
**The conflict:**
1. Terraform tries to delete old SG first
...
## Status
RESOLVED - Manual detach during apply, documented prevention method
