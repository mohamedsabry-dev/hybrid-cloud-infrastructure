...
- `nginx_setup.yml` — once after the ex-nginx LXC is provisioned and enrolled in FreeIPA. Runs via `{env}-nginx-full-setup.yml` workflow.
...
- [`../../../../kubernetes/dev/deployments/infrastructure/ingress/`](../../../../kubernetes/dev/deployments/infrastructure/ingress/) — ingress-nginx controller HelmRelease
