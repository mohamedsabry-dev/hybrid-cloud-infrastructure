...
- `flux_setup.yml` — invoked by `{env}-k8s-full-setup.yml` at the end, or manually. One-time per cluster (see `deployment-docs/k8s-flux-setup-guide.txt` for the GitHub PAT prerequisites)
