...
| `storage` | NFS-backed persistent storage | CSI driver + 3 StorageClasses against Synology NAS (`10.0.40.120:/volume1/k8s-prod`). `nfs-database` uses `hard` mounts with longer timeouts |
