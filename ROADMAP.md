...
++ SIgnla flow of internal k8s components  >> Move to after publish roadmap
++ Review the prope rediness and livense behaviour and solidate it >> on it 
++ Fix auto alarm fake ones issue , with temp silent and make the case workaround and keep it open >> 
++ signal flow of intgration 
