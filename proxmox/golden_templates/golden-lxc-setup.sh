...
echo "     pct stop 9001"
echo ""
echo "  3. Create backup using vzdump (to local storage):"
echo "     vzdump 9001 --compress gzip --storage local --mode stop"
echo ""
echo "  4. Move backup to template directory and rename:"
echo "     mv /var/lib/vz/dump/vzdump-lxc-9001-*.tar.gz /mnt/pve/nas-iso/template/cache/rocky-9-lxc-golden.tar.gz"
echo ""
echo "  5. Verify template is available:"
echo "     pveam list nas-iso"
echo ""
echo "  6. (Optional) Delete the source container:"
echo "     pct destroy 9001"
echo ""
echo "Note: Template path will be: nas-iso:vztmpl/rocky-9-lxc-golden.tar.gz"
echo "==============================================================================="
echo ""
