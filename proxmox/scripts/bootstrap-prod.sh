...
# 5. Create admin_prod Management User (PAM)
# 6. Create tf_prod Automation User
...
# --- 5. Create admin_prod Management User (PAM) ---
echo ""
echo "[5/6] Creating admin_prod management user (PAM)..."
...
# --- 6. Create tf_prod Automation User ---
echo ""
echo "[6/6] Creating tf_prod automation user..."
