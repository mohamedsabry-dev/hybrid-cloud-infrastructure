...
**See:** [04-design-decisions.md](../backup/04-design-decisions.md) for full rationale
...
**See:** [02-emergency-shutdown.md](../backup/02-emergency-shutdown.md) for shutdown details
...
**See:** [03-recovery-procedures.md](../backup/03-recovery-procedures.md) for restore details
...
**See:** [02-emergency-shutdown.md](../backup/02-emergency-shutdown.md) for script details
...
- [02-emergency-shutdown.md](../backup/02-emergency-shutdown.md) - Emergency shutdown details
- [03-recovery-procedures.md](../backup/03-recovery-procedures.md) - Veeam restore procedures
- [04-design-decisions.md](../backup/04-design-decisions.md) - Why cold standby?
- [05-configuration-reference.md](../backup/05-configuration-reference.md) - IP addresses, settings
