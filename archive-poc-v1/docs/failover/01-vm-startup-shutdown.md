...
- [02-emergency-shutdown.md](../backup/02-emergency-shutdown.md) - How DR script triggers these sequences
- [04-design-decisions.md](../backup/04-design-decisions.md) - Why this ordering? Why these delays?
- [05-configuration-reference.md](../backup/05-configuration-reference.md) - Quick reference for startup order
