...
See [Failover Documentation](../failover/) for:
...
See [User Accounts](../identity/01-user-accounts.md) for complete details.
...
- [Failover Procedures](../failover/) - ESXi failover and VM orchestration
...
### Automation
- [PowerShell DR Scripts](../../automation/scripts/powershell/) - Emergency shutdown scripts
...
- [01-user-accounts.md](../identity/01-user-accounts.md) - Located in identity folder
